...
excerpt: "Causality can be casual"
---
...
For phenomena that occur in complex contexts, we need a method to develop and test hypotheses in order to build knowledge. This is the focus of many causal frameworks, and the focus of many ongoing research.

If you want to read more about causality, here are some resources:
- Ferenc Huszar wrote an exellent series of posts about Causal Inferences and how to understand them on his blog [inFERENCe](https://www.inference.vc/untitled/)
